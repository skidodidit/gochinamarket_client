...
export default function CategorySection({ categories }: CategorySectionProps) {
  ...
  return (
    <section className="w-full max-w-7xl mx-auto md:px-10 px-5 py-8">
      {/* Header */}
        ...
        {categories?.map((category) => {
          ...
          return (
            <div
              ...
              className="flex flex-col items-center justify-center py-6 px-4 cursor-pointer transition-all duration-300 bg-white border border-gray-200  hover:border-primary-300 hover:shadow-md"
            >
